...
public class RayCtrl : MonoBehaviour
{
    ...
    void SingleRayDepthCamEachHand(GameObject controller, GameObject ib)
    {
        ...
        // TODO:
        // instantiate babyIb
        // calculation babyIb position
        // update baby ib position
            // to calculate the babyIb position
            // first find id relative to big eb, aka, relative position vector
            // and relative to minimap, offset the relative position vector
                // scaled by the stupid scale of minimap versus the big eb
        //GameObject babyIb = Instantiate(indicatorBall, miniMap.transform.position, Quaternion.identity);
